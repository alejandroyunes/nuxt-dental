...
const nicwellF5025: ProductDetails = {
  ...
  features: {
    ...
    data: [
      ...
      {
        title: 'Ease of Use',
        description: 'The product is consistently complemented for its ease of use, providing a convenient and user-friendly alternative to traditional flossing. If you prefer a hassle-free oral care routine, the oral irrigator could be a beneficial addition.'
      },
      {
        title: 'Performance',
